...
public class WeatherController {
	...
	@GetMapping
	public ResponseEntity<List<WeatherDto>> findAllByOrderByTimestampDesc(){
		return new ResponseEntity<List<WeatherDto>>(this.weatherService.findAllByOrderByTimestampDesc(),HttpStatus.OK);
	}
}
